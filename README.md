...
It's meant to be included in your rebar projects in your rebar.config file:
		...
		{deps, [
			{rabbit_common, ".*", {git, "git://github.com/jbrisbin/rabbit_common.git", "rabbitmq-3.4.0"}}
		]}.
...
to the version tag:
		...
		{deps, [
			{rabbit_common, ".*", {git, "git://github.com/jbrisbin/rabbit_common.git", "rabbitmq-3.4.0-community"}}
		]}.
